...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const rowCountDisplay = document.getElementById('rowCountDisplay');
           ...
           if (!addRowsBtn || !numRowsInput || !testingTableBody || !addRowsBtn2 || !numRowsInput2 || !testingTableBody2 || !addRowsBtn3 || !numRowsInput3 || !testingTableBody3) {
           return;
       }
    ...
    function addRowsToTable(tableBody, n) {
        ...
        rows.forEach(row => {
         ...
         for (let i = 0; i < n; i++) {
             ...
             const columnCount = tableBody.id === 'testingTableBody2' ? 15 : 10;
