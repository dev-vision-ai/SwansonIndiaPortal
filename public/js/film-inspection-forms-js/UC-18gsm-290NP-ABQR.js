...
function setFormTitle() {
    ...
    if (formTitle) {
        ...
        if (productCodeInput && productCodeInput.value) {
            ...
            formTitle.textContent = 'UC-18gsm-290NP-ABQR';
        }
    }
}
...
function applyOOSValidation(input, columnType) {
    ...
    switch(columnType) {
        ...
        // Page 3 parameters
        case 'colourL':
            // Colour L: L-53.00 T-59.00 U-65.00 (Colour units-H)
            shouldHighlight = value < 53.00 || value > 65.00;
            break;
        case 'colourA':
            // Colour A: L-31.00 T-36.00 U-41.00 (Colour units-H)
            shouldHighlight = value < 31.00 || value > 41.00;
            break;
        case 'colourB':
            // Colour B: L-(-28.00) T-(-24.00) U-(-20.00) (Colour units-H)
            shouldHighlight = value < -28.00 || value > -20.00;
            break;
        case 'deltaE':
            ...
            break;
        case 'baseFilmPurple':
            // Base Film Purple: T-0.00 U-4.00 (Colour Units-Delta E) - only upper limit
            shouldHighlight = value > 4.00;
            break;
    }
            ...
            if (input) {
                ...
                if (inputIndex > 2) {
                    ...
                    if (tableBody.id === 'testingTableBody') {
                        ...
                        else if (inputIndex === 7) columnType = 'baseFilmPurple';
                    }
