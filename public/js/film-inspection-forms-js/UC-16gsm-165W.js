...
function getHistoricalTotalRows(historicalData) {
    ...
    const candidateKeys = [
        ...
        'page1_basis_weight', 'page1_thickness', 'page1_cof_rr', 'page1_tensile_break', 'page1_elongation', 'page1_modulus',
...
function loadHistoricalRowData(row, historicalData, historicalRow) {
    ...
    if (row.closest('#testingTableBody')) {
        ...
        // Load Page 1 data - Updated to match actual HTML structure (6 columns)
        const page1Data = [
            { key: 'page1_basis_weight', inputIndex: 3 }, // Film Weight
            { key: 'page1_thickness', inputIndex: 4 }, // Thickness
            { key: 'page1_cof_rr', inputIndex: 5 }, // COF (R-R)
            { key: 'page1_tensile_break', inputIndex: 6 }, // Tensile Break
            { key: 'page1_elongation', inputIndex: 7 }, // MD Elongation Break
            { key: 'page1_modulus', inputIndex: 8 } // 10% Modulus
        ];
