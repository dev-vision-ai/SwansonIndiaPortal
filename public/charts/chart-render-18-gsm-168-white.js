...
const METRIC_SPECS = { 
    ...
    'tensileStrength5MDChart': { label: 'Force Elongation 5% (N) MD', usl: 5.5, tgt: 4.0, lsl: 2.5, min: 2.0, max: 6.5, unit: 'N', col: 'tensile-strength-5-md', table: 'testingTableBody2', color: 'rgb(76, 175, 80)' }, 
    // Page 3 
...
async function fetchInspectionDataFromDB() {
    try {
        ...
        const filmTableNames = [
            '168_18c_white',      // Specific table for this product
            '168_16c_white',      
            '168_16cp_kranti',
            '176_18cp_ww',
