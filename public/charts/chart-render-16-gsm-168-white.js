...
const METRIC_SPECS = { 
    // Page 1 
    'basisWeightChart': { label: 'Basis Weight', usl: 18.00, tgt: 16.00, lsl: 14.00, min: 12, max: 20, unit: 'GSM', col: 'basis-weight', color: 'rgb(54, 162, 235)' }, 
    ...
    'tensileStrengthMDChart': { label: 'Force~Tensile Strength@Break(N)MD', tgt: 12.0, lsl: 9.0, min: 8.0, max: 16.0, unit: 'N', col: 'tensile-strength-md', table: 'testingTableBody2', color: 'rgb(255, 205, 86)' }, 
    'tensileStrength5MDChart': { label: 'Force~Tensile Strength@Break 5% (N)MD', usl: 5.5, tgt: 4.0, lsl: 2.5, min: 2.0, max: 6.0, unit: 'N', col: 'tensile-strength-5-md', table: 'testingTableBody2', color: 'rgb(76, 175, 80)' }, 
    // Page 3 
    ...
    'tensileStrengthCDChart': { label: 'Force~Tensile Strength@Break (N) CD', tgt: 9.0, lsl: 6.0, min: 5.0, max: 12.0, unit: 'N', col: 'tensile-strength-cd', table: 'testingTableBody3', color: 'rgb(233, 30, 99)' }, 
    'modulusWebChart': { label: 'Modulus Web@ 2%', usl: 40.0, tgt: 30.0, lsl: 20.0, min: 15.0, max: 45.0, unit: 'N/cm', col: 'modulus-web', table: 'testingTableBody3', color: 'rgb(0, 150, 136)' }, 
    // Page 4 
    ...
    'colorAChart': { label: 'Color A', usl: 2.9, tgt: -1.1, lsl: -5.1, min: -5, max: 5, unit: 'H', col: 'color-a', table: 'testingTableBody4', color: 'rgb(63, 81, 181)' }, 
    ...
    'glossChart': { label: 'Gloss', usl: 11.0, tgt: 9.0, min: 6, max: 12, unit: 'Gloss unit', col: 'gloss', table: 'testingTableBody4', color: 'rgb(0, 0, 0)' } 
};
