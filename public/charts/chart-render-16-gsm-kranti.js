...
const METRIC_SPECS = { 
    ...
    'cutWidthChart':    { label: 'Cut Width', usl: 170, tgt: 168, lsl: 166, min: 164, max: 172, unit: 'mm', col: 'cut-width', color: 'rgb(255, 205, 86)' }, 
    ...
    'tensileStrengthMDChart': { label: 'Force~Tensile Strength@Break(N)MD', tgt: 12.0, lsl: 9.0, min: 8.0, max: 16.0, unit: 'N', col: 'tensile-strength-md', table: 'testingTableBody2', color: 'rgb(244, 63, 94)' }, 
    'tensileStrength5MDChart': { label: 'Force~Tensile Strength@Break 5% (N)MD', usl: 5.5, tgt: 4.0, lsl: 2.5, min: 2.0, max: 6.0, unit: 'N', col: 'tensile-strength-5-md', table: 'testingTableBody2', color: 'rgb(245, 158, 11)' }, 
    // Page 3 
    ...
    'tensileStrengthCDChart': { label: 'Force~Tensile Strength@Break (N) CD', tgt: 9.0, lsl: 6.0, min: 5.0, max: 12.0, unit: 'N', col: 'tensile-strength-cd', table: 'testingTableBody3', color: 'rgb(225, 29, 72)' }, 
    ...
    for (const row of rows) {
        ...
        if (tableBodyId === 'testingTableBody') {
            const map = { 
                ...
                'cof': 6,
                'cut-width': 7,
                'color-delta-e-unprinted': 8,
                'color-delta-e-printed': 9
            };
